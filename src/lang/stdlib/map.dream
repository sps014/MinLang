...
struct Map<K, V> {
    ...
    fun rehash(): void {
        ...
        this.keys = array_new<K>(new_cap);
        this.values = array_new<V>(new_cap);
        this.states = array_new<int>(new_cap);
        this.cap = new_cap;
        this.count = 0;
        this.used = 0;
        let i = 0;
...
fun Map<K, V>(): Map<K, V> {
    return Map<K, V> {
        ...
        states: array_new<int>(8),
        defaults: array_new<V>(1),
        count: 0,
        used: 0,
        cap: 8
    };
